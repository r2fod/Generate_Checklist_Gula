// ─── PUERTA DE SESIÓN ──────────────────────────────────────────────────────────
// La usan las dos apps que piden cuenta de equipo: la CHECKLIST y el CALENDARIO. El
// formulario no pasa por aquí — entra por código (?enviar=), sin cuenta, porque lo
// rellena gente de fuera del equipo.
//
// Vive aparte de Acceso.jsx a propósito: aquí NO se importa App. Si la importara, el
// calendario se llevaría las 6.600 líneas de la checklist en su bundle solo por
// reutilizar el login. Un valor por defecto que apunte a App tampoco vale: es una
// referencia real y el empaquetador no puede quitarla.
